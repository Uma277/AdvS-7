...
public class WebdriverUtil
{
	WebDriver driver;
	/**
	 * *This below methos is used to maximize the window
	 * @param driver
	 */
	public static void maximaizeTheWindow(WebDriver driver)
	{
	...
	/**
	 * This below mwthos is used to refresh the page
	 * @param driver
	 * @return 
	 */
	...
	/**
	 * this below methos is used for implicitly wait
	 *@param driver
	 */
	...
	/**
	 * This methos is used to switch the frame using webelement
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * this method is used to scroll window up using javascript executor
	 * @param driver
	 */
